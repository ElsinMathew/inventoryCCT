      ...
      <section>
        <div class="page-header min-vh-100 ">
          <div class="container">
            <div class="row">
              <div
                class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto mt-5"
              >
                <div class="card card-plain mt-5">
                  <div class="card-header pb-0 text-start mt-5">
                    <h4 class="font-weight-bolder mt-5">Log In</h4>
                  ...
                  <div id="loginMessage"></div>
                    <form method="POST" action="" class="form-control-lg">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="loginPassword" name="loginPassword" value="<?php echo $loginPassword; ?>">
                      </div>
                      <style>
