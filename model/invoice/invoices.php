...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO sale (customerName, customerMobile, customerEmail, customerAddress, invoiceType, invoiceNumber, saleDate, invoiceStatus, subtotal, discount, total) 
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($conn, $sql);
  
  // Bind parameters
  mysqli_stmt_bind_param($stmt, 'ssssssssddd', $customer_name, $customer_phone, $customer_email, $customer_address_1, $invoice_type, $invoice_number, $invoice_date, $invoice_type, $invoice_subtotal, $invoice_discount, $invoice_total);
