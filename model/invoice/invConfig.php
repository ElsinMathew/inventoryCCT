...
// COMPANY INFORMATION
define('COMPANY_LOGO', '../../assets/img/CCTWhiteLOGO.png');
...
define('COMPANY_COUNTY', 'IN'); // Use 'IN' for India
define('COMPANY_POSTCODE', '10100');

define('COMPANY_NUMBER', 'Company No: 699400000'); // Company registration number
define('COMPANY_VAT', 'Company GST: 27ABCDE1234F1Z5'); // GST (Goods and Services Tax) for an Indian company


// EMAIL DETAILS
define('EMAIL_FROM', 'pinto28130@gmail.com'); // Email address invoice emails will be sent from
define('EMAIL_NAME', 'Invoice Mg System'); // Email from address
define('EMAIL_SUBJECT', 'Invoice Mg Email'); // Invoice email subject
...
define('FOOTER_NOTE', 'WDI@AUG 2023');
