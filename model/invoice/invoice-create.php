...
<form action="invoices.php" method="post">
			...
			<div class="col-xs-4 no-padding-right">
				<div class="form-group">
					<div class="input-group date" id="invoice_date">
						<input type="text" class="form-control required" name="invoice_date" placeholder="Invoice Date" id="invoice_date" data-date-format="<?php echo DATE_FORMAT ?>" />
			...
			<tr>
				...
				<td>
					<div class="form-group form-group-sm  no-margin-bottom">
						...
						<input type="text" class="form-control form-group-sm item-input invoice_product" id="invoice_product" name="invoice_product[]" placeholder="Enter Product Name OR Description">
	...
	<div class="col-xs-6 margin-top btn-group">
		...
		<input type="submit" class="btn btn-success float-right" value="Create Invoice" data-loading-text="Creating...">
	</div>
