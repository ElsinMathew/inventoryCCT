...
<form action="invoices.php" method="post" onsubmit="return validateForm();" id="invoiceForm">
    <div class="container">
                ...
                <div class="card rounded shadow pb-0 pt-3">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <input type="text" class="form-control margin-bottom copy-input required" name="customer_name" id="customer_name" placeholder="Name" tabindex="1">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control margin-bottom copy-input required" name="customer_phone" id="customer_phone" placeholder="Phone Number" tabindex="3">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control margin-bottom copy-input " name="customer_email" id="customer_email" placeholder="Email" tabindex="5">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control margin-bottom copy-input " name="customer_address_1" id="customer_address_1" placeholder="Address" tabindex="7">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form method="post" id="create_invoice">
                            ...
                            <div class="form-group">
                                ...
                                <select name="invoice_status" id="invoice_status" class="form-control" type="submit">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="invoice_date">
                                    <input type="date" class="form-control required" name="invoice_date" id="invoice_date" placeholder="Invoice Date" data-date-format="<?php echo DATE_FORMAT ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="invoice_id" value="<?php echo $invoiceNumber ?>">
                                <input type="hidden" name="customer_id" id="customer_id" value="<?php echo $customerID ?>">
                                <div class="input-group">
                                    <input type="text" class="form-control required" placeholder="Invoice Number" disabled aria-describedby="sizing-addon1" value="#<?php echo $invoiceNumber ?>">
                                </div>
                            </div>
                        </form>
                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control item-input invoice_product" name="invoice_product[]" id="invoice_product" placeholder="Enter Product Name OR Select">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control calculate invoice_product_price required" name="invoice_product_price[]" placeholder="0.00">
                                            </div>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control calculate" id="invoice_product_discount" name="invoice_product_discount[]" placeholder="Enter % OR Price">
                                        </td>
                                        <td>
                                            <div class="input-group">
        ...
        <div class="col-lg-4 float-right" style="left: 12%;">
            ...
            <div class="row">
                <div class="col-xs-4 col-xs-offset-5">
                    <strong>GST </strong>
                    <?php echo CURRENCY ?>
                    <span class="invoice-vat float-right" data-enable-vat="<?php echo ENABLE_VAT ?>" data-vat-rate="<?php echo VAT_RATE ?>" data-vat-method="<?php echo VAT_INCLUDED ?>">0.00</span>
