...
!(function (t, e) {
  ...
  var a = new (class {
    ...
    _update(t = Date.now()) {
      ...
      e._charts.forEach((n, o) => {
        if (!n.running || !n.tables.length) return;
        const s = n.tables;
        let a,
          r = s.length - 1,
          l = !1;
    ...
    add(t, e) {
      e && e.length && this._getAnims(t).tables.push(...e);
    }
    has(t) {
      return this._getAnims(t).tables.length > 0;
    }
    start(t) {
      ...
      e &&
        ((e.running = !0),
          (e.start = Date.now()),
          (e.duration = e.tables.reduce((t, e) => Math.max(t, e._duration), 0)),
          this._refresh());
    }
    running(t) {
      if (!this._running) return !1;
      const e = this._charts.get(t);
      return !!(e && e.running && e.tables.length);
    }
    stop(t) {
      const e = this._charts.get(t);
      if (!e || !e.tables.length) return;
      const i = e.tables;
      let n = i.length - 1;
      for (; n >= 0; --n) i[n].cancel();
      (e.tables = []), this._notify(t, e, Date.now(), "complete");
    }
    remove(t) {
  ...
  class ji extends Oi {
    constructor(t) {
      super(),
        ...
        (this.max = void 0),
        (this.ticks = []),
        (this._gridLinetables = null),
        (this._labeltables = null),
    ...
    drawGrid(t) {
      const e = this,
        ...
        r = e._gridLinetables || (e._gridLinetables = e._computeGridLinetables(t));
      let l, c;
      const h = (t, e, i) => {
        i.width &&
          i.color &&
    ...
    drawLabels(t) {
      ...
      n && Gt(i, n);
      const o = e._labeltables || (e._labeltables = e._computeLabeltables(t));
      let s, a;
  ...
  class kn {
    ...
    _createDescriptors(t, e) {
      const i = t && t.config,
        ...
        o = (function (t) {
          const e = [],
            i = Object.keys(wn.plugins.tables);
  ...
  class ps extends Oi {
    ...
    _createtables(t) {
      ...
      return (
        ...
        t.tablesort && (c = c.sort((e, i) => t.tablesort(e, i, n))),
        J(c, (i) => {
  ...
  var ms = {
    ...
    descriptors: {
      _scriptable: (t) =>
        "filter" !== t && "tablesort" !== t && "external" !== t,
      _indexable: !1,
  ...
  class Os extends ys {
    ...
    fit() {
      ...
      e.display && e.pointLabels.display
        ? (function (t) {
          ...
          var c, h, d;
          t._setReductions(t.drawingArea, e, i), (t._pointLabeltables = []);
          const u = t.options,
            f = ks(u),
    ...
    getPointLabelPosition(t) {
      const { left: e, top: i, right: n, bottom: o } = this._pointLabeltables[t];
  ...
  return (
    ...
    (Yn.Animations = bi),
    (Yn.animator = a),
    (Yn.controllers = wn.controllers.tables),
